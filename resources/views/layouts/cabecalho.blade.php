                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4 items-center justify-center">
                        ...
                        <a href="{{ route('home') }}" id="#sobre"
                            class="nav_link sm:text-sm md:text-base font-poppin font-medium rounded-md px-3 py-2 hover:bg-red-100  hover:font-semibold">Sobre</a>
                        ...
                        <a href="{{ route('lugares_cadastrados') }}"
                            class="text-base text-center hover:scale-105 text-black shadow-lg font-poppins font-normal rounded-lg px-3 py-2 w-[7rem] hover:font-medium bg-rose_medium">Cadastrar</a>
                    </div>
                </div>
            </div>
