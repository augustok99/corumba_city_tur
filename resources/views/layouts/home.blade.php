    ...
    <div class="mt-14 flex ml-40 w-[65rem] h-[34rem] z-0">
        <div
            ...
            <div id="default-carousel" data-carousel="slide"
                ...
                <!-- Carousel wrapper -->
                <div id="carousel-example" class="relative h-full overflow-hidden rounded-lg md:h-96">
                    <!-- Item 1 -->
                    <div id="carousel-item-1"
                        class="carousel-item absolute w-full h-full transition-opacity duration-500 ease-in-out"
                        data-carousel-item>
